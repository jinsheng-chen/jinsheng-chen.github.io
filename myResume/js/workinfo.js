...
function ufoFn(){
    ...
    var ufo_img = ufo.getElementsByTagName('img')[0];
    var ufo_image = ufo.getElementsByClassName('image')[0];
    var light = document.getElementsByClassName('light')[0];
    var mp3Ufo = document.getElementById('mp3ufo');
    ufo_image.style.webkitTransform = 'translateY(0) rotate(0)';
    ufo_image.style.transform = 'translateY(0) rotate(0)';
    ...
    setTimeout(function(){
        ...
        var ufoNum = 0;
        ufo_image.style.transition = 'none';
        ufo_image.style.webkitTransition = 'none';
        var ufoTimer = setInterval(function(){

            ufo_image.style.backgroundPosition = 0 + ' ' + -ufoNum * 244 +'px';
            ufoNum++;
            if(ufoNum>13){
        ...
        ufo_img.style.display = 'block';
        setTimeout(function(){

            ufo_img.className = 'light_shake';

        },12);
        setTimeout(function(){

            ufo_img.style.display = 'none';

        },1000);
        workInfoFn(ufo_image);
