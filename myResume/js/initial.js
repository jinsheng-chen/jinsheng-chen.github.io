...
function init(){
    ...
    var oImg = work.getElementsByTagName('img')[0];
    ...
    for(var i=0; i<Json.project.length; i++){
        ...
        if(Json.project.length == 1) oLi.className = 'initial';
    ...
    oImg.src = Json.work[0].logo;
    oP.innerHTML = Json.work[0].date;
    aP[0].innerHTML = '工作职位：' + Json.work[0].job;
    ...
    //
    //}
    //oP3.innerHTML += '<span class="shake" style="visibility: visible;">　</span>';
